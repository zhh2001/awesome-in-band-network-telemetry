...
- **FreshINT** — Freshness-aware early reporting in in-band network telemetry systems — *IEEE INFOCOM*. [Paper](https://doi.org/10.1109/INFOCOM59046.2026.11571376)
- **INTo6** — In-band network telemetry over IPv6 — *IEEE WCNC*. [Paper](https://doi.org/10.1109/WCNC65185.2026.11555103)
- **AI-INT** — An AI-driven telemetry framework for programmable networks — *ICDCIT*. [Paper](https://doi.org/10.1007/978-3-032-16632-6_20)
- Leveraging FPGA-based SmartNICs for low-latency in-band network telemetry — *ICIN*. [Paper](https://doi.org/10.1109/ICIN69025.2026.11481846)

### 2025

- **FINT** — Freshness-based in-band network-wide telemetry in resource-constrained environments — *IEEE TNSM*. [Paper](https://doi.org/10.1109/TNSM.2024.3500586)
...
- **Patrol** — Max-min passive-active hybrid in-band network telemetry method in SDN — *IEEE ISPA*. [Paper](https://doi.org/10.1109/ISPA67752.2025.00082)
- **ATINT** — Planning for anomaly-tolerant probing for network-wide in-band network telemetry — *IEEE ICC*. [Paper](https://doi.org/10.1109/ICC52391.2025.11160743)
- **TS-INT** — A hybrid in-band network telemetry architecture in cyclic queuing and forwarding networks — *CBD*. [Paper](https://doi.org/10.1109/CBD69312.2025.00049)
- **SRv6-ALINT** — SRv6-based efficient in-band network-wide telemetry across LANs — *ICCCN*. [Paper](https://doi.org/10.1109/ICCCN65249.2025.11133970)
- **INT-LLM** — Adaptive path planner for in-band network telemetry via large language models — *ICIC*. [Paper](https://doi.org/10.1007/978-981-96-9914-8_17)
- Network-wide data collection based on in-band network telemetry for digital twin networks — *IEEE TMC*. [Paper](https://doi.org/10.1109/TMC.2024.3456584)
- In-band network telemetry for software-defined wide area networks — *Computer Networks*. [Paper](https://doi.org/10.1016/j.comnet.2025.111567)

### 2024

- **AdapINT** — A flexible and adaptive in-band network telemetry system based on deep reinforcement learning — *IEEE TNSM*. [Paper](https://doi.org/10.1109/TNSM.2024.3427403)
...
- **P4InfoSen-INT** — Information-sensitive in-band network telemetry in P4-based programmable data plane — *IEEE/ACM ToN*. [Paper](https://doi.org/10.1109/TNET.2024.3448244)
...
- **SecPro-INT** — Secure programmable in-band network telemetry method — *ICCC*. [Paper](https://doi.org/10.1109/ICCC62609.2024.10941751)
- **ID-INT** — Secure inter-domain in-band telemetry — *CNSM*. [Paper](https://doi.org/10.23919/CNSM62983.2024.10814310)
- **SF-INT** — An integrated solution for high-efficiency in-band network telemetry — *APNet*. [Paper](https://doi.org/10.1145/3663408.3663425)
- Lightweight INT on the Tofino programmable switch — *ACM MobiCom*. [Paper](https://doi.org/10.1145/3636534.3696729)
- P4-based in-network telemetry for FPGAs in the Open Cloud Testbed and FABRIC — *IEEE INFOCOM Workshops*. [Paper](https://doi.org/10.1109/INFOCOMWKSHPS61880.2024.10620664)
- In-band network-wide telemetry for topology-varying LEO satellite networks — *IEEE GLOBECOM*. [Paper](https://doi.org/10.1109/GLOBECOM52923.2024.10900986)
- A flexible in-band network telemetry framework for heterogeneous private networks — *IEEE WFCS*. [Paper](https://doi.org/10.1109/WFCS60972.2024.10540842)
- Improved routing for the in-band network telemetry problem — *ICMSQUARE*. [Paper](https://doi.org/10.1007/978-3-031-52965-8_46)

### 2023

- **DLINT & PLINT** — Deterministic and probabilistic P4-enabled lightweight in-band network telemetry — *IEEE TNSM*. [Paper](https://doi.org/10.1109/TNSM.2023.3301839)
...
- **INT-Balance** — In-band network-wide telemetry with balanced monitoring path planning — *IEEE ICC*. [Paper](https://doi.org/10.1109/ICC45041.2023.10279077)
- **INTView** — Adaptive planner for in-band network telemetry without detours — *IEEE ICC*. [Paper](https://doi.org/10.1109/ICC45041.2023.10279624)
- **SaR4IO** — In-band network telemetry overhead reduction based on data flows sampling and recovering — *IEEE NetSoft*. [Paper](https://doi.org/10.1109/NetSoft57336.2023.10175471)
- **DINT** — A dynamic algorithm for in-band network telemetry — *SBRC*. [Paper](https://doi.org/10.5753/sbrc.2023.531)
- **MPolKA-INT** — Stateless multipath source routing for in-band network telemetry — *AINA*. [Paper](https://doi.org/10.1007/978-3-031-28451-9_45)
...
- Distributed in-band network telemetry — *IEEE/ACM CCGrid Workshops*. [Paper](https://doi.org/10.1109/CCGridW59191.2023.00060)
...
- **FINT** — Flexible in-band network telemetry method for data center network — *Computer Networks*. [Paper](https://doi.org/10.1016/j.comnet.2022.109232)
- **IntOpt** — In-band network telemetry optimization framework to monitor network slices using P4 — *Computer Networks*. [Paper](https://doi.org/10.1016/j.comnet.2022.109214)
- **FindINT** — Detect and locate the lost in-band network telemetry packet — *IEEE Networking Letters*. [Paper](https://doi.org/10.1109/LNET.2021.3067343)
- **INT-react** — An O(E) path planner for resilient network-wide telemetry over megascale networks — *IEEE ICNP*. [Paper](https://doi.org/10.1109/ICNP55882.2022.9940409)
...
- **GPINT** — Efficient network monitoring via in-band telemetry — *DRCN*. [Paper](https://doi.org/10.1109/DRCN51631.2021.9477344)
- **MPINT** — Multipath in-band network telemetry — *IEEE INFOCOM Workshops*. [Paper](https://doi.org/10.1109/INFOCOMWKSHPS51825.2021.9484494)
- **VXLAN-based INT** — In-band network telemetry for overlay network monitoring — *IEEE INFOCOM Workshops*. [Paper](https://doi.org/10.1109/INFOCOMWKSHPS51825.2021.9484508)
- **INT-probe** — Lightweight in-band network-wide telemetry with stationary probes — *IEEE ICDCS*. [Paper](https://doi.org/10.1109/ICDCS51616.2021.00090)
- **LINT** — Accuracy-adaptive and lightweight in-band network telemetry — *IFIP/IEEE IM*. [Paper](https://ieeexplore.ieee.org/document/9464012)
- Enabling in-band network telemetry in software-based virtual switches — *IEEE GLOBECOM*. [Paper](https://doi.org/10.1109/GLOBECOM46510.2021.9685530)
- Orchestrating probabilistic in-band network telemetry for network monitoring — *ICCC*. [Paper](https://doi.org/10.1109/ICCC54389.2021.9674307)
- In-band network telemetry task orchestration based on multi-objective optimization — *APNOMS*. [Paper](https://doi.org/10.23919/APNOMS52696.2021.9562646)
- A flexible P4-based pin-point in-band network monitoring — *APNOMS*. [Paper](https://doi.org/10.23919/APNOMS52696.2021.9562620)
- In-band network monitoring technique to support SDN-based wireless networks — *IEEE TNSM*. [Paper](https://doi.org/10.1109/TNSM.2020.3044415)
...
- **PINT** — Probabilistic in-band network telemetry — *ACM SIGCOMM*. [Paper](https://doi.org/10.1145/3387514.3405894)
...
- **S-INT** — Towards in-band telemetry for self-driving wireless networks — *IEEE INFOCOM Workshops*. [Paper](https://doi.org/10.1109/INFOCOMWKSHPS50562.2020.9162923)
- **Fast-INT** — Light-weight and efficient in-band network telemetry in programmable data plane — *IEEE VTC*. [Paper](https://doi.org/10.1109/VTC2020-Fall49728.2020.9348823)
- **INT-filter** — Mitigating data collection overhead for high-resolution in-band network telemetry — *IEEE GLOBECOM*. [Paper](https://doi.org/10.1109/GLOBECOM42002.2020.9348029)
- **Patcher** — Towards fault-tolerant probing planning for in-band network telemetry — *IEEE LATINCOM*. [Paper](https://doi.org/10.1109/LATINCOM50620.2020.9282348)
...
- **sINT** — Selective in-band network telemetry for overhead reduction — *IEEE CloudNet*. [Paper](https://doi.org/10.1109/CloudNet.2018.8549351)
- **POINT** — An intent-driven framework for integrated packet-optical in-band network telemetry — *IEEE ICC*. [Paper](https://doi.org/10.1109/ICC.2018.8422785)
- **INTCollector** — A high-performance collector for in-band network telemetry — *CNSM*. [Paper](https://ieeexplore.ieee.org/document/8584997)
- A practical implementation of in-band network telemetry in Open vSwitch — *IEEE CloudNet*. [Paper](https://doi.org/10.1109/CloudNet.2018.8549431)
...
* improving the scalability, flexibility, programmability, or deployment of INT.
